...
extern "C" char pkgver_in_libgemanx[];	/* exported from libgemanx,
...
int main(int argc, char *argv[])
{
	...
	/*--- Insanity checks for libgemanx. ---*/
	if (strcmp(pkgver_in_libgemanx, pkgver) != 0) {
		GtkWidget *w = gtk_window_new(GTK_WINDOW_TOPLEVEL);
		GtkWidget *dialog, *label, *content_area;
		/* Create the widgets */
		dialog = gtk_dialog_new_with_buttons (
				"GeManX Version " PACKAGE_VERSION,
				GTK_WINDOW(w),
		...
		label = gtk_label_new (
			_("Version mismatch between gemanx and libgemanx-core.\n\n"
