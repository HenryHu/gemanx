 ...
 : CWidget(), m_Site(site)
{
	...
	hbox3_1 = gtk_hbox_new (FALSE, 2);
	gtk_widget_show (hbox3_1);
	gtk_box_pack_start (GTK_BOX (m_Widget), hbox3_1, FALSE, TRUE, 0);
	gtk_container_set_border_width (GTK_CONTAINER (hbox3_1), 1);
	
	label3_1 = gtk_label_new (_("Reconnect interval : "));
	gtk_widget_show (label3_1);
	gtk_box_pack_start (GTK_BOX (hbox3_1), label3_1, FALSE, FALSE, 0);
	
	m_Reconnect_int = gtk_adjustment_new (0, 0, 65535, 1, 10, 0);
	m_Reconnect_int_btn = gtk_spin_button_new (GTK_ADJUSTMENT (m_Reconnect_int), 1, 0);
	gtk_widget_show (m_Reconnect_int_btn);
	gtk_box_pack_start (GTK_BOX (hbox3_1), m_Reconnect_int_btn, FALSE, TRUE, 0);
	
	label4_1 = gtk_label_new (_("Sec"));
	gtk_widget_show (label4_1);
	gtk_box_pack_start (GTK_BOX (hbox3_1), label4_1, FALSE, FALSE, 0);
...
//		gtk_widget_set_sensitive(m_Address, false);
	...
	gtk_spin_button_set_value( GTK_SPIN_BUTTON(m_Reconnect_int_btn), m_Site.m_ReconnectInt);
...
bool CSitePage::OnOK()
{
	...
	m_Site.m_ReconnectInt = gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(m_Reconnect_int_btn));
